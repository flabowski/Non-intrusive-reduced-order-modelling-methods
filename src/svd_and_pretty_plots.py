...
path = "C:/Users/florianma/Documents/Repositoties/nirom/doc/"
...
# load snapshots
u = np.load(path+"{:06.0f}to{:06.0f}_u_rho1.0.npy".format(n, n+J)).T  # n, t
v = np.load(path+"{:06.0f}to{:06.0f}_v_rho1.0.npy".format(n, n+J)).T  # n, t
p = np.load(path+"{:06.0f}to{:06.0f}_p_rho1.0.npy".format(n, n+J)).T  # n, t
